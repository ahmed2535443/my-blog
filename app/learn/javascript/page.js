// =====================================================
// ملف: page.js (صفحة مرحلة JavaScript + ES6+)
// المكان: app/learn/javascript/page.js
// الوظيفة: عرض جميع دروس مرحلة JavaScript مع شريط التقدم
...
export default function JavaScriptStagePage() {
  const stage = getStageById("javascript");
      ...
      <header className="mb-10">
        ...
        >
          <p className="text-sm" style={{ color: "#b8960a" }}>
            💡 هذه المرحلة تجمع أساسيات JavaScript مع المميزات الحديثة (ES6+) لتحضيرك لتعلم <strong>React</strong> بثقة.
          </p>
        </div>
