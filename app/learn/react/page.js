// =====================================================
// ملف: page.js (صفحة مرحلة React)
// المكان: app/learn/react/page.js
// الوظيفة: عرض جميع دروس مرحلة React مع شريط التقدم
// URL: /learn/react
// =====================================================
...
export default function ReactStagePage() {
  const stage = getStageById("react");
      ...
      <header className="mb-10">
        ...
        >
          <p className="text-sm" style={{ color: "var(--primary)" }}>
            💡 هذا المنهج مُعدَّل للعمل مع <strong>Next.js</strong> - ستجد دروساً عن Server Components و Server Actions بدلاً من React Router التقليدي.
          </p>
        </div>
