...
export default function DynamicProgrammingPage() {
  return (
    <div dir="rtl" className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-12">
        ...
        <LessonSection title="مقدمة في Dynamic Programming">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            البرمجة الديناميكية (Dynamic Programming) هي تقنية تحليلية تستخدم لحل المسائل الحسابية عن طريق تقسيمها إلى مشاكل فرعية أصغر وحفظ نتائج هذه المشاكل الفرعية لتجنب إعادة حسابها. تُعد من أهم تقنيات حل المسائل في علوم الحاسوب.
          </p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
            تعتمد البرمجة الديناميكية على مبدأين رئيسيين: التراكبية (Optimal Substructure) والبروبيرتي الفرعية المتراكبة (Overlapping Subproblems). التراكبية تعني أن الحل الأمثل للمشكلة يمكن بناؤه من الحلول الأمثل لمشاكلها الفرعية.
          </p>
        </LessonSection>

        <LessonSection title="المشاكل الأساسية">
          <ProblemCard
            id={1}
  ...
  return dp[n];
          ...
          <ProblemCard
            ...
            difficulty="medium"
            category="Dynamic Programming"
            description="أنت لص يخطط للسطو على أouses مجاورة. كل house يحتوي على مبلغ مالي معين، لكن إذا سرقت house متجاورة فسيتم إخطار الشرطة. ما هو الحد الأقصى للمبلغ الذي يمكنك سرقته؟"
            examples={[
              { input: "nums = [1,2,3,1]", output: "4" },
              { input: "nums = [2,7,9,3,1]", output: "12" },
            ]}
            hints={[
              "لا يمكنك سرقت house متجاورتين",
  ...
  return dp[nums.length - 1];
            ...
            solutionApproach="dp[i] يمثل الحد الأقصى للمبلغ عند الوصول لل дома i. عند كل home، لدينا خياران: إما سرقته (نضيف قيمته مع dp[i-2]) أو عدم سرقته (نحتفظ بـ dp[i-1]). نأخذ المجموع الأكبر."
          />
          ...
          <ProblemCard
            ...
            difficulty="medium"
            category="Dynamic Programming"
            description="أعطى مجموعة من العملات的各种面值 وقيمة مستهدفة، اكتب دالة تحدد الحد الأدنى لعدد العملات المطلوبة للوصول للقيمة المستهدفة. يمكنك استخدام كل عملة بلا حدود."
            examples={[
            ...
            hints={[
              ...
              "dp[i] يمثل الحد الأدنى لعدد العملات للوصool للقيمة i",
  ...
  return dp[amount] === Infinity ? -1 : dp[amount];
          ...
          <ProblemCard
            ...
            difficulty="medium"
            category="Dynamic Programming"
            description="أعطى مصفوفة أرقام، اكتب دالة ت找出 أطول متتالية متصاعدة (غير متتالية بالضرورة) في المصفوفة."
            examples={[
  ...
  return dp[n];
        ...
        <LessonSection title="المشاكل المتقدمة">
          <ProblemCard
            id={6}
            title="Edit Distance"
            difficulty="hard"
  ...
  return dp[1][n];
          ...
          <ProblemCard
            ...
            difficulty="hard"
            category="Dynamic Programming"
            description="تنفيذ تطابق regex يدعم '.' و '*'. '.' يطابق أي حرف واحد، و '*' يطابق صفر أو أكثر من الحرف السابق له. الت matching يجب أن تغطي السلسلة كاملة."
            examples={[
