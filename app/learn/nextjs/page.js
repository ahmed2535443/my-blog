// =====================================================
// ملف: page.js (صفحة مرحلة Next.js)
// المكان: app/learn/nextjs/page.js
// الوظيفة: عرض جميع دروس مرحلة Next.js مع شريط التقدم
// URL: /learn/nextjs
// =====================================================
...
export default function NextjsStagePage() {
  const stage = getStageById("nextjs");
      ...
      <header className="mb-10">
        ...
        >
          <p className="text-sm" style={{ color: "var(--muted)" }}>
            📌 المنهج مُحدَّث لـ <strong>Next.js 16</strong> - يتضمن Cache Components، Turbopack الافتراضي، Proxy (بدل Middleware)، و React Compiler.
          </p>
        </div>
