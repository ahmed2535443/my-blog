// =====================================================
// ملف: page.js (صفحة مرحلة HTML)
// المكان: app/learn/html/page.js
// الوظيفة: عرض جميع دروس مرحلة HTML مع شريط التقدم
// URL: /learn/html
// =====================================================
        ...
        <div className="space-y-4">
          {stage.lessons.map((lesson, index) => (
            ...
            >
              ...
              {/* سهم */}
              <span
                className="text-lg transition-transform duration-300 group-hover:-translate-x-2 shrink-0"
