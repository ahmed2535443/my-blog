const translations = {
  ar: {
    sections: [
      {
        title: "ما هي إمكانية الوصول ولماذا هي مهمة؟",
        content: [
          { type: "p", text: "إمكانية الوصول (تُعرف أيضاً بـ A11y — عدد الحروف بين A و y هو 11) هي ممارسة تصميم المواقع والتطبيقات بحيث تكون متاحة للجميع، بغض النظر عن قدراتهم أو إعاقاتهم." },
          { type: "p", text: "إمكانية الوصول تضمن أن جميع المستخدمين — بمن فيهم ذوي الإعاقة — يمكنهم التفاعل مع موقعك واستخدامه بفعالية. هذه ليست \"رفاهية\" بل مسؤولية أخلاقية وقانونية في كثير من البلدان." },
          { type: "callout", title: "تشبيه بسيط", text: "تخيّل أنك تبني مبنى. هل ستوفّر فقط الدرج؟ لا، تحتاج مصعداً ومنحدرات للكراسي المتحركة وبطاقات برايل. إمكانية الوصول هي نفس الشيء لكن للمواقع — جعلها متاحة للجميع." },
          { type: "p", text: "الأرقام تتحدث: حوالي 15-20% من سكان العالم يعانون من شكل من أشكال الإعاقة. تجاهلهم يعني فقدان مجموعة كبيرة من المستخدمين والعملاء المحتملين." }
        ]
      },
      {
        title: "من يستفيد من إمكانية الوصول؟",
        content: [
          { type: "p", text: "إمكانية الوصول ليست فقط للمكفوفين، بل لجميع المجموعات:" },
          { type: "li", text: "المكفوفون وضعاف البصر: يستخدمون قارئات الشاشة التي تقرأ محتوى الصفحة بصوت عالٍ. يحتاجون نص alt للصور وعناصر مُعرّفة بشكل صحيح." },
          { type: "li", text: "ضعفاء السمع: يحتاجون ترجمة للفيديوهات ونصاً بديلاً للمحتوى الصوتي." },
          { type: "li", text: "الأشخاص ذوو الإعاقة الحركية: يستخدمون لوحة المفاتيح أو أجهزة تحكم خاصة للتنقل بدلاً من الماوس." },
          { type: "li", text: "الأشخاص ذوو الاضطرابات الإدراكية: يحتاجون تصميماً واضحاً وبسيطاً بهيكل محتوى منطقي." },
          { type: "li", text: "كبار السن: قد يعانون من ضعف البصر أو المهارات الحركية الدقيقة. يحتاجون خطوطاً كبيرة وأزراراً واضحة." },
          { type: "li", text: "المستخدمون في ظروف غير مثالية: شاشة صغيرة، إضاءة خافتة، اتصال بطيء. إمكانية الوصول تحسن التجربة للجميع." }
        ]
      },
      {
        title: "العناصر الأساسية لإمكانية الوصول",
        content: [
          { type: "h3", text: "1. النص البديل للصور (alt)" },
          { type: "p", text: "كل صورة يجب أن تحمل نصاً بديلاً يصف محتواها. هذا النص يقرأه قارئ الشاشة و يظهر عند فشل تحميل الصورة." },
          { type: "h3", text: "2. التسميات (Labels)" },
          { type: "p", text: "كل حقل إدخال يجب أن يكون له تسمية واضحة تربطه بالوصف שלו." },
          { type: "h3", text: "3. التسلسل المعنوي" },
          { type: "p", text: "استخدم العناوين بترتيب هرمي صحيح (h1 ثم h2 ثم h3) لبناء هيكل واضح للمحتوى." },
          { type: "h3", text: "4. التباين اللوني" },
          { type: "p", text: "تأكد من أن النص يكون مقروءاً على الخلفية. النسبة الموصى بها هي 4.5:1 على الأقل." },
          { type: "h3", text: "5. التكبير" },
          { type: "p", text: "يجب أن تعمل الصفحة بشكل صحيح عند تكبير النص إلى 200%." }
        ]
      },
      {
        title: "سمات ARIA",
        content: [
          { type: "p", text: "سمات ARIA (Accessible Rich Internet Applications) تُستخدم لتحسين إمكانية الوصول للعناصر التفاعلية:" },
          { type: "li", text: "<code>role</code>: يحدد دور العنصر (مثل role=\"button\"، role=\"navigation\")" },
          { type: "li", text: "<code>aria-label</code>: يعطي العنصر اسماً م读不出来的 (يُستخدم عندما لا يوجد نص مرئي)" },
          { type: "li", text: "<code>aria-describedby</code>: يربط العنصر بوصف إضافي" },
          { type: "li", text: "<code>aria-hidden</code>: يخفي العنصر عن قارئ الشاشة" },
          { type: "callout", title: "ملاحظة مهمة", text: "استخدم سمات ARIA فقط عندما لا توجد بدائل HTML أصلية. مثلاً، استخدم <code>&lt;button&gt;</code> بدلاً من <code>&lt;div role=\"button\"&gt;</code>." }
        ]
      },
      {
        title: "أفضل الممارسات لإمكانية الوصول",
        content: [
          { type: "li", text: "<strong>استخدم العلامات الدلالية:</strong> header، nav، main، article، section." },
          { type: "li", text: "<strong>أضف نص alt لكل صورة:</strong> حتى الصور الزخرفية تحتاج alt فارغاً." },
          { type: "li", text: "<strong>استخدم labels لكل حقل:</strong> واربطها بـ for و id." },
          { type: "li", text: "<strong>تأكد من التسلسل المعنوي:</strong> لا تخطي مستويات العناوين." },
          { type: "li", text: "<strong>اختبر باللوحة المفاتيح:</strong> تأكد من أن جميع العناصر التفاعلية قابلة للوصول بـ Tab." },
          { type: "li", text: "<strong>استخدم ألواناً عالية التباين:</strong> للنصوص على الخلفيات." }
        ]
      },
      {
        title: "ملخص الدرس",
        content: [
          { type: "li", text: "إمكانية الوصول = جعل الموقع متاحاً للجميع" },
          { type: "li", text: "نص alt للصور، labels للحقول، تسلسل عنوان صحيح" },
          { type: "li", text: "سمات ARIA لتحسين التفاعلية" },
          { type: "li", text: "اختبر الموقع باللوحة المفاتيح والتباين اللوني" },
          { type: "li", text: "إمكانية الوصول تفيد الجميع، لا فقط ذوي الإعاقة" }
        ]
      }
    ],
    quiz: [
      {
        question: "لماذا نص alt مهم للصور؟",
        options: [
          "لتحسين سرعة تحميل الصفحة",
          "لفهم الصورة من قبل قارئ الشاشة ومحركات البحث",
          "لإضافة تأثيرات حركية",
          "لتغيير حجم الصورة تلقائياً"
        ],
        explanation: "نص alt مهم لثلاثة أسباب: إمكانية الوصول (قارئ الشاشة يقرأه)، SEO (محركات البحث تفهم الصورة)، وعرض الصورة عند فشل التحميل."
      }
    ],
    challenge: {
      title: "تحدي: صفحة متوافقة مع إمكانية الوصول",
      description: "أنشئ صفحة HTML تتضمن: 1. صورة بنص alt وصفي، 2. نموذج بـ labels لكل حقل، 3. تسلسل عنوان صحيح (h1 → h2 → h3)، 4. نص ب alta contrast ratio، 5. عناصر قابلة للوصول بلوحة المفاتيح."
    },
    cheatSheet: {
      title: "ملخص إمكانية الوصول",
      items: [
        { term: "<code>alt</code>", definition: "نص بديل للصور (إجباري)" },
        { term: "<code>&lt;label&gt;</code>", definition: "تسمية حقل الإدخال (إجباري)" },
        { term: "<code>role</code>", definition: "دور العنصر لـ ARIA" },
        { term: "<code>aria-label</code>", definition: "اسم مخفي للعنصر" },
        { term: "<code>tabindex</code>", definition: "ترتيب التنقل بلوحة المفاتيح" },
        { term: "T contrast ratio", definition: "التباين الأدنى للنصوص: 4.5:1" }
      ]
    }
  },
  en: {
