const translations = {
  ar: {
    sections: [
      { title: "مقدمة في التكرار الذاتي والتنقيب الخلفي", content: [
        { type: "p", text: "التكرار الذاتي هو تقنية تتبع فيها دالة نفسها. يستخدم التكرار الذاتي استكشاف جميع الحلول الممكنة وإلغاء الاختيارات عندما تؤدي إلى طرق مسدودة." },
        { type: "callout", title: "ما سنتعلمه", text: "أساسيات التكرار الذاتي، الحالات الأساسية، Memorization، نمط التكرار الخلفي، ومشاكل كلاسيكية مثل N-Queens و Sudoku." }
      ]},
      { title: "كيف يعمل التكرار الذاتي", content: [
        { type: "p", text: "للدالة التكرارية جزآن: حالة أساسية تتوقف عندها التكرار، وحالة تكرارية تستدعي نفسها بمدخل أصغر." },
        { type: "callout", title: "القواعد الرئيسية", text: "1. يكون لديك دائمًا حالة أساسية. 2. تتقدم نحو الحالة الأساسية. 3. تثق أن الاستدعاء التكراري سيعمل." }
      ]},
      { title: "Memorization", content: [
        { type: "p", text: "يخزن Memorization النتائج المحسوبة لتجنب الحسابات التكرارية، مما يقلل الوقت الأسي إلى وقت متعدد الحدود." },
        { type: "callout", title: "النمط", text: "استخدم Map/ذاكرة مؤقتة لتخزين النتائج. قبل الحساب، تحقق مما إذا كان مخزنًا بالفعل. احفظ النتيجة بعد الحساب." }
      ]},
      { title: "نمط التكرار الخلفي", content: [
        { type: "p", text: "يستكشف التكرار الخلفي جميع الاختيارات الممكنة، ويعود عندما يؤدي اختيار إلى حالة غير صالحة. يُستخدم لمشاكل التوافقيات." },
        { type: "callout", title: "النمط", text: "اختر ← استكشف ← ألغِ (عُد) ← جرب الاختيار التالي. شائع في التوافقيات ومشاكل القيود." }
      ]},
      { title: "المجموعات الفرعية والتوافقيات", content: [
        { type: "p", text: "أنشئ جميع المجموعات الفرعية أو التوافقيات عن طريق اتخاذ اختيارات في كل خطوة والعودة لاستكشاف البدائل." },
        { type: "callout", title: "النهج", text: "للمجموعات الفرعية: اشمل/استبعد كل عنصر. للتوافقيات: اختر كل عنصر متاح وتكرار على المتبقي." }
      ]},
      { title: "N-Queens ومشاكل القيود", content: [
        { type: "p", text: "ضع الملكات صفًا بصف، تحقق من صلاحية كل موضع. عُد عندما لا يكون هناك موضع صالح في صف." },
        { type: "callout", title: "التحقق", text: "تحقق من العمود والقطري (أعلى اليسار) والقطري المعاكس (أعلى اليمين) للتعارضات." }
      ]}
    ],
    quiz: [
      { question: "ما هما الجزآن الأساسيان للدالة التكرارية؟",
        options: ["الحلقة والشرط", "الحالة الأساسية والحالة التكرارية", "المدخل والمخرج", "الدالة والمتغير"],
        correctAnswer: 1, explanation: "يجب أن تحتوي كل دالة تكرارية على حالة أساسية (للإيقاف) وحالة تكرارية (للمتابعة بمدخل أصغر)." },
      { question: "ما هو Memorization؟",
        options: ["تقنية فرز", "تخزين النتائج المحسوبة لتجنب الحسابات التكرارية", "نوع من الحلقات", "إدارة الذاكرة"],
        correctAnswer: 1, description: "يخزن Memorization نتائج الاستدعاءات الباهظة لتجنب إعادة حسابها." },
      { question: "متى تستخدم التكرار الخلفي؟",
        options: ["لحلقات بسيطة", "لمشاكل توافقيات ذات اختيارات متعددة", "لفرز المصفوفات", "لاستعلامات قاعدة البيانات"],
        correctAnswer: 1, explanation: "يُستخدم التكرار الخلفي لمشاكل تتطلب استكشاف جميع التكوينات الممكنة، مثل التوافقيات ورضا القيود." }
    ],
    challenge: { title: "تحدي: التكرار الذاتي والتنقيب الخلفي",
      description: "نفّذ Fibonacci باستخدام Memorization، حل مشكلة المجموعات الفرعية باستخدام التكرار الخلفي، ثم حل N-Queens." },
    cheatSheet: { title: "مرجع التكرار الذاتي والتنقيب الخلفي السريع", items: [
      { title: "الحالة الأساسية", content: "يجب إيقاف التكرار - حدد دائمًا أولاً!" },
      { title: "الحالة التكرارية", content: "استدعي نفسك بمدخل أصغر نحو الحالة الأساسية" },
      { title: "Memorization", content: "خزن النتائج لتجنب استدعاءات O(2^n) التكرارية" },
      { title: "التكرار الخلفي", content: "اختر ← استكشف ← ألغِ ← جرب التالي" }
    ]}
  },
  en: {
    sections: [
