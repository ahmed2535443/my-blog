const translations = {
  ar: {
    sections: [
      { title: "مقدمة في المكدس والقائمة", content: [
        { type: "p", text: "المكدس والقائمة هما هياكل بيانات خطية تحتفظ بالعناصر في ترتيب محدد. يتبع المكدس LIFO (الأخير يدخل الأول يخرج)، تتبع القائمة FIFO (الأول يدخل الأول يخرج)." },
        { type: "callout", title: "ما سنتعلمه", text: "عمليات المكدس، عمليات القائمة، المكدس الأحادي، ومشاكل مثل Valid Parentheses و Daily Temperatures." }
      ]},
      { title: "أساسيات المكدس", content: [
        { type: "p", text: "يتبع المكدس LIFO: العنصر الأخير المُضاف هو الأول الذي يُزال. العمليات الرئيسية: push، pop، top، isEmpty." },
        { type: "callout", title: "حالات الاستخدام", text: "الأقواس المتوازنة، التراجع/إعادة، مكدس استدعاء الدوال، تجذور DFS، تعبيرات التقييم." }
      ]},
      { title: "أساسيات القائمة", content: [
        { type: "p", text: "تتبع القائمة FIFO: العنصر الأول المُضاف هو الأول الذي يُزال. العمليات الرئيسية: enqueue، dequeue، front، isEmpty." },
        { type: "callout", title: "حالات الاستخدام", text: "تجذور BFS، جدولة المهام، قائمة الطباعة، قوائم الرسائل." }
      ]},
      { title: "المكدس الأحادي", content: [
        { type: "p", text: "يحافظ المكدس الأحادي على العناصر بترتيب تصاعدي أو تنازلي. يُستخدم لإيجاد العنصر الأكبر/الأصغر التالي بفعالية." },
        { type: "callout", title: "النمط", text: "لكل عنصر، أزل العناصر التي تنتهك الأحادية، عالج العناصر المُزالة، أضف العنصر الحالي." }
      ]},
      { title: "المكدس لتقييم التعبيرات", content: [
        { type: "p", text: "تُستخدم المكدسات لتقييم تعبيرات postfix وفك ترميز الهياكل المتداخلة مثل النصوص مع الأقواس." },
        { type: "callout", title: "النمط", text: "لـ Reverse Polish Notation: أضف الأرقام، عند العامل أزل عاملين وأضف النتيجة." }
      ]},
      { title: "تنفيذ القائمة باستخدام المكدسات", content: [
        { type: "p", text: "يمكن تنفيذ القائمة باستخدام مكدسين: واحد للإدخال وواحد للإخراج، لتحقيق عمليات O(1) متوسطة." },
        { type: "callout", title: "النمط", text: "مكدس الإدخال للـ enqueue. عندما يكون الإخراج فارغًا، انقل الكل من الإدخال إلى الإخراج للـ dequeue/peek." }
      ]}
    ],
    quiz: [
      { question: "ماذا يعني LIFO؟",
        options: ["الأخير يدخل الأول يخرج", "إدخال خطي إخراج وظيفي", "قائمة في خارج الدالة", "حلقة إدخال لإخراج"],
        correctAnswer: 0, explanation: "LIFO تعني Last In First Out - العنصر الأخير المُضاف هو الأول الذي يُزال (سلوك المكدس)." },
      { question: "ما هو المكدس الأحادي يُستخدم لإيجاد؟",
        options: ["تخزين بيانات مرتبة", "إيجاد العنصر الأكبر/الأصغر التالي بفعالية", "تنفيذ القوائم", "تجذور الأشجار"],
        correctAnswer: 1, explanation: "يحافظ المكدس الأحادي على الترتيب لإيجاد العنصر الأكبر أو الأصغر التالي بفعالية في وقت O(n)." },
      { question: "كيف تنفذ قائمة باستخدام مكدسين؟",
        options: ["غير ممكن", "مكدس الإدخال للـ enqueue، مكدس الإخراج للـ dequeue، انقل عند الحاجة", "استخدم مكدسًا واحدًا فقط", "استخدم التكرار الذاتي"],
        correctAnswer: 1, explanation: "مكدس واحد للـ enqueue، والآخر للـ dequeue. انقل العناصر من الإدخال إلى الإخراج عندما يكون مكدس الإخراج فارغًا." }
    ],
    challenge: { title: "تحدي: المكدس والقائمة",
      description: "نفّذ Valid Parentheses و Daily Temperatures باستخدام المكدس الأحادي، وفك ترميز نص متداخل باستخدام المكدسات." },
    cheatSheet: { title: "مرجع المكدس والقائمة السريع", items: [
      { title: "المكدس", content: "LIFO، push/pop/top جميعها O(1)، يُستخدم لـ DFS، الأقواس" },
      { title: "القائمة", content: "FIFO، enqueue/dequeue جميعها O(1)، تُستخدم لـ BFS، الجدولة" },
      { title: "المكدس الأحادي", content: "حافظ على الترتيب، أوجد العنصر الأكبر/الأصغر التالي في O(n)" },
      { title: "القائمة عبر المكدسات", content: "مكدسان، O(1) متوسط لكل عملية" }
    ]}
  },
  en: {
    sections: [
