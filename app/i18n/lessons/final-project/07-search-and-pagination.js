const translations = {
  ar: {
    sections: [
      { title: "مقدمة في البحث والتقسيم", content: [
        { type: "p", text: "البحث والتقسيم ضروريان لأي مدونة تحتوي على الكثير من المقالات. يغطي هذا الدرس تنفيذ البحث باستخدام Supabase ومعلمات URL ومكونات التقسيم." },
        { type: "callout", title: "المواضيع المغطاة", text: "البحث باستخدام Supabase ilike والبحث النصي الكامل، معلمات URL مع Next.js، مكونات التقسيم، حقل البحث المتأخر، اقتراحات الإكمال التلقائي." }
      ]},
      { title: "البحث باستخدام Supabase", content: [
        { type: "p", text: "استخدم العامل ilike للبحث النصي البسيط أو البحث النصي الكامل للمطابقة المتقدمة مع الترتيب." },
        { type: "callout", title: "طرق البحث", text: "ilike للمطابقة النمطية غير حساسة للحالة، أو() للبحث في أعمدة متعددة، textSearch للبحث النصي الكامل في PostgreSQL مع الترتيب." }
      ]},
      { title: "البحث النصي الكامل", content: [
        { type: "p", text: "يوفر البحث النصي الكامل في PostgreSQL مطابقة نصية أكثر تطورًا مع tsvector و tsquery ودوال الترتيب." },
        { type: "callout", title: "فوائد البحث النصي الكامل", text: "أسرع من LIKE لمجموعات البيانات الكبيرة، يدعم جذور الكلمات والترتيب، يمكنه وزن حقول مختلفة بشكل مختلف." }
      ]},
      { title: "معلمات البحث القائمة على URL", content: [
        { type: "p", text: "جعل معلمات URL ي يجعل البحث قابلًا للحفظ والمشاركة. يوفر Next.js searchParams لقراءة سلاسل استعلام URL." },
        { type: "callout", title: "فوائد معلمات URL", text: "الحفظ والمشاركة تعمل بشكل صحيح، صديق لـ SEO مع صفحات البحث المفهرسة، التنقل بالزر الأمامي/الخلفي في المتصفح يعمل بشكل طبيعي." }
      ]},
      { title: "مكون التقسيم", content: [
        { type: "p", text: "يقسم التقسيم النتائج إلى صفحات مع ترقيم التنقل وأزرار السابق/التالي ونقطاط للعدادات الكبيرة." },
        { type: "callout", title: "منطق التقسيم", text: "احسب إجمالي الصفحات من العدد والحد، اعرض أرقام صفحات ذكية مع نقاطاط، حافظ على معلمات البحث عبر الصفحات." }
      ]},
      { title: "حقل البحث المتأخر", content: [
        { type: "p", text: " يؤخر debounce استعلام البحث حتى يتوقف المستخدم عن الكتابة، مما يقلل من استدعاءات API غير الضرورية." },
        { type: "callout", title: "كيف يعمل Debounce", text: "ينتظر 300 مللي ثانية بعد الضغط الأخير قبل تنفيذ البحث، يمنع إطلاق طلب لكل حرف مكتوب." }
      ]},
      { title: "اقتراحات الإكمال التلقائي", content: [
        { type: "p", text: "اعرض اقتراحات البحث بينما يكتب المستخدم، بما في ذلك عناوين المقالات والتصنيفات." },
        { type: "callout", title: "ميزات الإكمال التلقائي", text: "اعرض اقتراحات للمقالات والتصنيفات، دعم التنقل بلوحة المفاتيح، انقر للانتقال مباشرة إلى النتائج." }
      ]}
    ],
    quiz: [
      { question: "ما هي ميزة معلمات URL مقارنة بـ useState للبحث؟",
        options: ["أداء أسرع", "تجعل البحث قابلًا للحفظ والمشاركة وصديقًا لـ SEO", "تستخدم أقل من الذاكرة", "تتطلب أقل من الكود"],
        correctAnswer: 1, explanation: "تجعل معلمات URL حالة البحث مستمرة في URL، مما يتيح الحفظ والمشاركة وفهرسة SEO." },
      { question: "ماذا يفعل hook Debounce؟",
        options: ["يرسل البحث فورًا", "ؤخر تنفيذ البحث حتى يتوقف المستخدم عن الكتابة", "يمسح حقل البحث", "يخزن سجل البحث"],
        correctAnswer: 1, explanation: "ينتظر Debounce توقف مؤقت في الكتابة (عادة 300 مللي ثانية) قبل تنفيذ البحث، مما يقلل الطلبات غير الضرورية." },
      { question: "أي وظيفة Supabase تُستخدم للبحث غير الحساس للحالة؟",
        options: ["eq()", "like()", "ilike()", "textSearch()"],
        correctAnswer: 2, explanation: "يؤدي ilike مطابقة نمطية غير حساسة للحالة مع دعم بدل (%) للبحث النصي المرن." },
      { question: "لماذا نستخدم range(offset, limit - 1) في Supabase للتقسيم؟",
        options: ["لحذف السجلات", "لتحديد النتائج على الصفحة الحالية", "لفرز النتائج", "لعد السجلات"],
        correctAnswer: 1, explanation: "يحدد range() نتائج الاستعلام على مجموعة فرعية محددة. الإزاحة تتخطى الصفحات السابقة، limit - 1 يحدد نهاية النطاق." }
    ],
    challenge: { title: "تحدي: إضافة التصفية حسب التصنيف",
      description: "أضف تصفية التصنيف إلى صفحة بحث المدونة. أنشئ مكون CategoryFilter، مرر التصنيف كمعلمة URL، صفي استعلام Supabase حسب التصنيف." },
    cheatSheet: { title: "مرجع البحث والتقسيم", items: [
      { title: "بحث Supabase", content: ".ilike('title', '%query%')، .or()، .rpc('search_posts')" },
