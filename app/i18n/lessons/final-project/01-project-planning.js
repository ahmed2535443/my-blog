    ...
    sections: [
      {
        ...
        content: [
          { type: "p", text: "في هذه المرحلة الأخيرة من المنهج، سنقوم ببناء مشروع حقيقي يجمع كل ما تعلمناه. المشروع هو <strong>مدونة احترافية</strong> تتيح للمستخدمين إنشاء وإدارة المقالات." },
          { type: "p", text: "لماذا مدونة؟ لأنها مشروع مثالي لتعلم تطوير الويب لأنها تتضمن:" },
          { type: "li", text: "<strong>CRUD كامل:</strong> إنشاء وقراءة وتحديث وحذف المقالات" },
          { type: "li", text: "<strong>نظام المصادقة:</strong> تسجيل الدخول وحسابات المستخدمين" },
          { type: "li", text: "<strong>قاعدة بيانات حقيقية:</strong> تخزين البيانات والعلاقات" },
          { type: "li", text: "<strong>تصميم متجاوب:</strong> يعمل على جميع الأجهزة" },
          { type: "li", text: "<strong>البحث والتصفية:</strong> العثور على المقالات بسرعة" },
          { type: "callout", title: "الميزات الأساسية للمدونة", text: "الصفحة الرئيسية تعرض جميع المقالات المنشورة، صفحة تفاصيل المقال، نظام تسجيل الدخول والتسجيل، لوحة تحكم المستخدم لإدارة المقالات، إنشاء وتعديل وحذف المقالات، نظام التصنيفات لتنظيم المقالات، بحث المقالات، تصميم متجاوب مع الوضع الداكن." }
        ]
      },
      {
        title: "تحليل المتطلبات",
        content: [
          { type: "p", text: "قبل كتابة أي كود، نحتاج إلى فهم بدقة ما نحتاجه. تحليل المتطلبات هو أهم خطوة في أي مشروع لأنه يمنعنا من إضافة ميزات غير ضرورية أو نسيان ميزات مهمة." },
          { type: "p", text: "<strong>المتطلبات الوظيفية:</strong> هذه هي الميزات التي يجب على التطبيق تنفيذها:" },
          { type: "li", text: "<strong>عرض المقالات:</strong> تعرض الصفحة الرئيسية جميع المقالات المنشورة (أولوية عالية)" },
          { type: "li", text: "<strong>تفاصيل المقال:</strong> صفحة مخصصة لكل مقال بالكامل (أولوية عالية)" },
          { type: "li", text: "<strong>المصادقة:</strong> تسجيل الدخول والتسجيل للمستخدمين (أولوية عالية)" },
          { type: "li", text: "<strong>إدارة المقالات:</strong> إنشاء وتعديل وحذف المقالات من لوحة التحكم (أولوية عالية)" },
          { type: "li", text: "<strong>التصنيفات:</strong> تصنيف المقالات إلى فئات مختلفة (أولوية متوسطة)" },
          { type: "li", text: "<strong>البحث:</strong> البحث في عناوين ومحتوى المقالات (أولوية متوسطة)" },
          { type: "li", text: "<strong>التعليقات:</strong> إضافة تعليقات على المقالات (أولوية منخفضة)" },
          { type: "p", text: "<strong>المتطلبات غير الوظيفية:</strong> تتعلق بكيفية عمل التطبيق وليس ما يفعله:" },
          { type: "li", text: "الأداء: يجب أن تُحمل الصفحة الرئيسية في أقل من 3 ثوانٍ" },
          { type: "li", text: "الأمان: حماية بيانات المستخدمين باستخدام RLS" },
          { type: "li", text: "المرونة: يعمل بشكل جيد على الهاتف والحاسوب" },
          { type: "li", text: "قابلية الصيانة: كود نظيف ومنظم وسهل التطوير" },
          { type: "li", text: "تجربة المستخدم: واجهة سهلة وواضحة" }
        ]
      },
      {
        title: "المجموعة التقنية",
        content: [
          { type: "p", text: "اخترنا مجموعة من التقنيات المتكاملة جيدًا لبناء مشروع المدونة. كل أداة تحل مشكلة محددة:" },
          { type: "li", text: "<strong>Next.js 16 - إطار عمل React:</strong> يوفر التوجيه القائم على الملفات، وإعدادات الخادم، وجلب البيانات من جانب الخادم، وتحسين SEO التلقائي." },
          { type: "li", text: "<strong>Supabase - Backend كخدمة:</strong> يُستخدم لقاعدة بيانات PostgreSQL، وتخزين الملفات، والميزات اللحظية. يوفر API سهلة لعمليات قاعدة البيانات." },
          { type: "li", text: "<strong>Clerk - مصادقة المستخدمين:</strong> يدير حسابات المستخدمين وتسجيل الدخول. يوفر مكونات جاهزة وخيارات مصادقة متعددة." },
          { type: "li", text: "<strong>Tailwind CSS - إطار عمل CSS:</strong> يُستخدم للتصميم السريع للواجهة باستخدام الفئات المساعدة بدلاً من CSS المخصص." },
          { type: "callout", title: "لماذا هذا المزيج؟", text: "Next.js يتعامل مع التوجيه والعرض، Supabase يتعامل مع البيانات والتخزين، Clerk يتعامل مع المصادقة، وTailwind يتعامل مع التنسيق. معًا يوفرون حلًا متكاملًا كاملًا." }
        ]
      },
      {
        title: "هيكل المشروع",
        content: [
          { type: "p", text: "قبل أن نبدأ في البرمجة، نحتاج إلى تخطيط هيكل الملفات. الهيكل الجيد يجعل الكود أسهل في الفهم والصيانة." },
          { type: "p", text: "يتبع هذا الهيكل أفضل ممارسات Next.js:" },
          { type: "li", text: "<strong>app/:</strong> يحتوي على جميع الصفحات والمسارات (توجيه قائم على الملفات)" },
          { type: "li", text: "<strong>components/:</strong> يحتوي على المكونات القابلة لإعادة الاستخدام" },
          { type: "li", text: "<strong>lib/:</strong> يحتوي على الإعدادات ودوال المساعدة" },
          { type: "li", text: "<strong>middleware.js:</strong> يحمي المسارات المحمية (مثل لوحة التحكم)" },
          { type: "callout", title: "نصيحة: لماذا هذا الهيكل؟", text: "هذا الهيكل يجعل الكود أسهل في الفهم لأن كل مجلد له غرض محدد. عندما تريد تعديل شيء محدد، تعرف بالضبط أين تذهب. هذا هو سر قابلية الصيانة الجيدة." }
        ]
      },
      {
        title: "ملخص التخطيط",
        content: [
          { type: "p", text: "الآن لدينا فهم واضح لما نحتاجه لبناء مشروع المدونة. دعنا نلخص ما تعلمناه:" },
          { type: "li", text: "المشروع هو مدونة احترافية باستخدام Next.js + Supabase + Clerk + Tailwind" },
          { type: "li", text: "نحتاج إلى تحليل المتطلبات قبل البدء في البرمجة" },
          { type: "li", text: "هيكل الملفات الجيد يبسط الصيانة والتطوير" },
          { type: "li", text: "نبدأ بالمتطلبات الأساسية ثم نضيف الميزات الإضافية تدريجيًا" }
        ]
      }
    ],
    quiz: [
      {
        ...
        options: [
          ...
          "لأنه لا يحتاج إلى الإنترنت"
        ],
        correctAnswer: 1,
        explanation: "يوفر Supabase قاعدة بيانات PostgreSQL حقيقية مع أمان على مستوى الصفوف (RLS) التي تحمي البيانات على مستوى الصف. هذا يجعله مثاليًا للمشاريع التي تحتاج إلى أمان قوي."
      }
    ],
    challenge: {
      title: "تحدي التخطيط: خطط لمشروعك الخاص",
      description: "قبل الانتقال إلى الدرس التالي، خطط لمشروعك الخاص. اختر فكرة وحدد: 1. ما هي الفكرة؟ (مثل: متجر إلكتروني، تطبيق مهام، منتدى) 2. ما هي الميزات الأساسية التي تحتاجها؟ 3. ما هي المجموعة التقنية المناسبة؟ 4. ما هو هيكل الملفات المقترح؟ اكتب إجاباتك على ورق أو في ملف نصي. هذا سيساعدك على تطوير مهارات التخطيط."
    },
    cheatSheet: {
      title: "مرجع التخطيط السريع",
      items: [
        { title: "1. تحديد الفكرة", content: "اكتب وصفًا موجزًا لمشروعك" },
        { title: "2. تحليل المتطلبات", content: "حدد الميزات الأساسية والإضافية" },
